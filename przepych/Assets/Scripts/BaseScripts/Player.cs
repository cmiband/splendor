...
public class Player : MonoBehaviour
{
    ...
    {
        Console.WriteLine("Chcesz kupiæ now¹ kartê czy kupiæ zarezerwowan¹?");
        ...
        {
            Console.WriteLine("Niepoprawny poziom. WprowadŸ 1 lub 2");
        }
        ...
        if (opChoice == 1)
        {
            ...
            {
                Console.WriteLine("Niepoprawny poziom. WprowadŸ 1, 2 lub 3:");
            }
            ...
            {
                Console.WriteLine("Niepoprawny wybór. WprowadŸ numer odpowiadaj¹cy wybranej karcie:");
            }
            ...
            if (success)
            {
                Console.WriteLine("Karta zosta³a pomyœlnie zakupiona!");
                board.ReplaceMissingCard(level, selectedCard);
                return true;
            }
            else
            {
                Console.WriteLine("Operacja kupowania karty nie powiod³a siê.");
                return false;
            }
        }
        else
    ...
    public bool HandleBuyReservedCard(Board board, Bank bank)
    {
        ...
        Console.WriteLine("Wybierz zarezerwowan¹ kartê, któr¹ chcesz kupiæ: ");
    ...
    {
        Console.WriteLine("Czy chcesz u¿yæ z³otego ¿etonu aby zap³aciæ za kartê?");
        ...
        {
            Console.WriteLine("Nie staæ ciê na tê kartê.");
            return false;
        }
            ...
            if (requiredAmount > 0)
            {
                ...
                else
                {
                    ...
                    if (choiceForGolden && colorOfChoice == color)
                    {
                        ...
                        {
                            Console.WriteLine("Nie masz wystarczaj¹cej liczby z³otych ¿etonów.");
                            return false;
                        }
                    }
                    else
                    {
                        Console.WriteLine($"Nie masz wystarczaj¹cej iloœci ¿etonów koloru {color}.");
                        return false;
                    }
                }
            }
        ...
        Console.WriteLine($"Karta {card} zosta³a zakupiona!");
        return true;
    }
    ...
    {
        hand.Add(card);
        Console.WriteLine($"Dodano kartê z nastêpuj¹c¹ liczb¹ punktów: {card.Points}");
    }
    ...
    public bool WantToSpendGoldCoin()
    {
        ...
        while (true)
        {
            ...
            if (wantTo == 2)
                ...
                Console.WriteLine("Podano z³y klawisz. Podaj 1 lub 2");
        }
    }
    public GemColor ColorToBePaidWithGolden()
    {
        Console.WriteLine("Podaj kolor ¿etonu, zamiast którego u¿yjesz z³otego ¿etonu:");
